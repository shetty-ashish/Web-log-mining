<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <div id="box" style="width:800px auto; height: auto; background-color:white; ">
 <?php 
 include("data.php");
 ...
 <div style="width:800px; height:100px;background-color:white;">
 
 <div id="click" style=" width:213px; height:90px;float:right" class="clickopen">
 </div> <hr/></div></div>
<div style="width:800px; margin:0 auto;">
 <div style="width:800px auto; height: auto; background-color:white; ">
